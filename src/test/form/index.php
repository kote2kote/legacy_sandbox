...
<body>
  ...
  <form action="<?php if($kakunin ==0){$_SERVER['PHP_SELF'];}else{ print "commit.php";} ?>" method="post" id="inquiry" name="fm" onSubmit="return chk()">
	...
	if($kakunin ==0){
		...
		?>
          <input type="text" name="zipcode1" size="3" maxlength="3" id="zipcode1" class="text2" onfocus="focusColor(this)" onblur="blurColor(this)" value="<?php if(isset($_REQUEST['zipcode1'])){ echo h($_REQUEST['zipcode1']);} ?>" />
          -
          <input type="text" name="zipcode2" size="4" maxlength="4" id="zipcode2" class="text2" onfocus="focusColor(this)" onblur="blurColor(this)" value="<?php if(isset($_REQUEST['zipcode2'])){ echo h($_REQUEST['zipcode2']);} ?>" />
          <?php } else { ?>
          <input type="hidden" name="zipcode1" value="<?php if(isset($_REQUEST['zipcode1'])){ echo h($_REQUEST['zipcode1']);} ?>" />
          <input type="hidden" name="zipcode2" value="<?php if(isset($_REQUEST['zipcode2'])){ echo h($_REQUEST['zipcode2']);} ?>" />
          <?php if(isset($_REQUEST['zipcode1'])){ echo h($_REQUEST['zipcode1']);} ?>-<?php if(isset($_REQUEST['zipcode2'])){ echo h($_REQUEST['zipcode2']);} ?>
          <?php } ?>
        </td>
      </tr>
      <!--都道府県-->
	...
	if($kakunin ==0){?>
		...
		?>
              ...
              // if(isset(h($_REQUEST['adress1'])){if(h($_REQUEST['adress1']) == $key){print " selected=\"selected\"";};} 
              if(isset($_REQUEST['adress1'])) {
                if(h($_REQUEST['adress1'])) {
                  print " selected=\"selected\"";
                }
              }
              ?>><?php print $key; ?></option>
              <?php
		 }
		 ?>
          </select>
          <?php } else { ?>
          <input type="hidden" name="adress1" value="<?php if(isset($_REQUEST['adress1'])){ echo h($_REQUEST['adress1']);} ?>" />
          <?php if(isset($_REQUEST['adress1'])){ echo h($_REQUEST['adress1']);} ?>
          <?php } ?>
        </td>
      </tr>
      <!--市区町村・番地-->
      <tr>
        ...
        <td><?php
	if($kakunin ==0){?><input type="text" name="adress2" size="30" id="adress2" class="text3" onfocus="focusColor(this)" onblur="blurColor(this)" value="<?php if(isset($_REQUEST['adress2'])){ echo h($_REQUEST['adress2']);} ?>" />
          <?php } else { ?>
          <input type="hidden" name="adress2" value="<?php if(isset($_REQUEST['adress2'])){ echo h($_REQUEST['adress2']);} ?>" />
          <?php if(isset($_REQUEST['adress2'])){ echo h($_REQUEST['adress2']);} ?>
          <?php } ?>
        </td>
      </tr>
      <tr>
        ...
        <td><?php
	if($kakunin ==0){?><input type="text" name="adress3" size="30" id="adress3" class="text3" onfocus="focusColor(this)" onblur="blurColor(this)" value="<?php if(isset($_REQUEST['adress3'])){ echo h($_REQUEST['adress3']);} ?>" />
          <?php } else { ?>
          <input type="hidden" name="adress3" value="<?php if(isset($_REQUEST['adress3'])){ echo h($_REQUEST['adress3']);} ?>" />
          <?php if(isset($_REQUEST['adress3'])){ echo h($_REQUEST['adress3']);} ?>
          <?php } ?>
        </td>
	...
	if($kakunin ==0){
		if($email_message){ print "<span class=\"err_message\">".$email_message."</span><br />";} ?>
          <input type="text" name="email" size="30" id="email" class="text3" onfocus="focusColor(this)" onblur="blurColor(this)" value="<?php if(isset($_REQUEST['email'])){ echo h($_REQUEST['email']);}  ?>" />
          <?php } else { ?>
          <input type="hidden" name="email" value="<?php if(isset($_REQUEST['email'])){ echo h($_REQUEST['email']);} ?>" />
          <?php if(isset($_REQUEST['email'])){ echo h($_REQUEST['email']);} ?>
          <?php } ?>
        </td>
      </tr>
      <!--お問い合わせの種類-->
	...
	if($kakunin ==0){
		if($faq_naiyou_message){ print "<span class=\"err_message\">".$faq_naiyou_message."</span><br />";} ?>
          <textarea name="faq_naiyou" cols="30" rows="15" id="faq_naiyou" class="text4" onfocus="focusColor(this)" onblur="blurColor(this)"><?php if(isset($_REQUEST['faq_naiyou'])){ echo h($_REQUEST['faq_naiyou']);} ?></textarea>
          <?php } else { ?>
          <input type="hidden" name="faq_naiyou" value="<?php if(isset($_REQUEST['faq_naiyou'])){ echo h($_REQUEST['faq_naiyou']);} ?>" />
          <?php if(isset($_REQUEST['faq_naiyou'])){ echo h($_REQUEST['faq_naiyou']);} ?>
          <?php } ?>
        </td>
      </tr>
    </table>
