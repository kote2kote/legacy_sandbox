			...
			<div id="box_right">
				...
				<div id="subbox_right">
					...
					<h2><?php echo $page_title;?></h2>
						<div align="center">
							<form method="post" action="add.php" class="search_form">
							新規追加：
							  <input type="text" name="new" value="<?php echo $key_word; ?>" maxlength="30" class="textbox1" /> <input type="submit" value="追加" name="submit" />
							</form>
						</div>
...
?>
<td><input type="submit" name="Submit2" value="変更"></td>
